...
namespace InventorySystem
{
    ...
    public class InventoryUIManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private List<string> toggleOnButtonPress;
        ...
        public void InvokeMiss(Vector3 pos, InventoryItem item) {
            ...
            if (ItemDropper.instance != null) {
                ItemDropper.instance.DropItem(pos, item);
            }
        }
        ...
        public void SetInvToggle(List<string> EnableDisableOnPress)
        {
            this.toggleOnButtonPress = EnableDisableOnPress;
        }

        public List<string> GetEnableDisable()
        {
